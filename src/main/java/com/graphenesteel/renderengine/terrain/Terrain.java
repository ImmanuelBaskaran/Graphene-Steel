package com.graphenesteel.renderengine.terrain;
...
public class Terrain {
    ...
    private RawMesh generateTerrain() {
        ...
        return new RawMesh(vertices, indices, textureCoords,normals);
    }
}
